...
class 사람 {
	...
	void 배달_음식_주문하다() {
		a좋아하는_음식점.주문받고_배달(이름, 전화번호, 선호하는_음식의_매운정도, 선호하는_음식);
	}
}
...
class 음식점 {
	...
	void 주문받고_배달(String 이름, String 전화번호, String 선호하는_음식의_매운정도, String 선호하는_음식) {
		System.out.printf("%s에서 %s(%s)에게 %s %s(을)를 배달합니다.\n", restaurantname, 이름, 전화번호, 선호하는_음식의_매운정도, 선호하는_음식);
	}
}

class 영화반점 extends 음식점 {
	영화반점() {
		this.restaurantname = "영화반점";
	}
